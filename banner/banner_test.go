...
func TestPrintTextBanner(t *testing.T) {
	// Test that printTextBanner doesn't panic
	assert.NotPanics(t, func() {
		printTextBanner()
	})
}

func TestPrintTextBanner_Output(t *testing.T) {
	// Test that printTextBanner produces output
